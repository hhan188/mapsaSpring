...
public class PostService
{
    ...
    public void publish(int id){
        ...
        transaction.begin();
        Query query = session.createQuery("update Post p set p.published = :isPublished where" +
                " p.postId = :postId");
    ...
    public List<Post> getAllPublishedPost(){
        Session session = sessionFactory.openSession();
        Query<Post> query = session.createQuery("select p from Post p where published =: published");
